...
class MainActivity : AppCompatActivity() {
        ...
        startButton.setOnClickListener {
            ...
            object : CountDownTimer(durationInMillis, intervalInMillis) {
                ...
                override fun onTick(millisUntilFinished: Long) {
                    ...
                    val secondsRemaining = (millisUntilFinished / 100).toInt()
    ...
    private fun generateRandomQuestion(operation: Int): Question {
        ...
        val num2 = when (operation) {
            ADDITION, SUBTRACTION, MULTIPLICATION -> random.nextInt(10) + 1 // Adjust the range as needed
            DIVISION -> generateRandomDivisor(num1)
            else -> random.nextInt(10) + 1 // Adjust the range as needed for other cases
        }
